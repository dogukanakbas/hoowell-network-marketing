...
ADD COLUMN IF NOT EXISTS authorized_first_name VARCHAR(100),
ADD COLUMN IF NOT EXISTS authorized_last_name VARCHAR(100),
ADD COLUMN IF NOT EXISTS registration_type ENUM('individual', 'corporate'),
ADD COLUMN IF NOT EXISTS contract1_accepted BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS contract2_accepted BOOLEAN DEFAULT FALSE,
