...
const PartnerRegistration = () => {
 ...
 {/* ADIM 3: Ürün Seçimi */}
      ...
      {currentStep === 4 && (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
              <input
                ...
                onChange={(e) => saveFormData({...formData, contract1_accepted: e.target.checked})}
          ...
          <div style={{
            ...
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
              <input
                ...
                onChange={(e) => saveFormData({...formData, contract2_accepted: e.target.checked})}
                style={{ marginRight: '10px', transform: 'scale(1.2)' }}
              />
              <span style={{ fontSize: '14px', color: 'var(--text-dark)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p>Bu sözleşme, elektronik ortamda gerçekleştirilen satış işlemlerini düzenler.</p>
              <p><strong>SATICI BİLGİLERİ:</strong></p>
              <p>HOOWELL GLOBAL ALKALİ İYONİZER SİSTEMLERİ ANONİM ŞİRKETİ</p>
              <p>Adres: Türkiye</p>
              <p>E-posta: info@hoowell.net</p>
              <p><strong>ALICI BİLGİLERİ:</strong></p>
              <p>Ad: {registrationType === 'individual' ? `${formData.first_name} ${formData.last_name}` : formData.company_name}</p>
              <p>E-posta: {formData.email}</p>
              <p>Telefon: {formData.phone}</p>
              <p><strong>ÜRÜN BİLGİLERİ:</strong></p>
              <p>Ürün Adı: HOOWELL İş Ortağı Paketi</p>
              <p>Fiyat: 4.800 TL (KDV Dahil)</p>
              <p><strong>ÖDEME VE TESLİMAT:</strong></p>
              <p>Ödeme: Kredi kartı, banka kartı veya havale ile</p>
              <p>Teslimat: Dijital içerik olarak anında teslim</p>
            </div>
            ...
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
              <input
                ...
                onChange={(e) => saveFormData({...formData, contract3_accepted: e.target.checked})}
                style={{ marginRight: '10px', transform: 'scale(1.2)' }}
              />
              <span style={{ fontSize: '14px', color: 'var(--text-dark)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p>Bu form, satın alacağınız ürün hakkında önceden bilgilendirme yapmak amacıyla düzenlenmiştir.</p>
              <p><strong>ÜRÜN BİLGİLERİ:</strong></p>
              <p>• Ürün Adı: HOOWELL İş Ortağı Paketi</p>
              <p>• Ürün Kategorisi: Dijital İçerik ve Franchise Hakları</p>
              <p>• Ürün Açıklaması: HOOWELL ürünlerini satma ve pazarlama hakları</p>
              <p><strong>FİYAT BİLGİLERİ:</strong></p>
              <p>• Satış Fiyatı: 4.800 TL</p>
              <p>• KDV Oranı: %20</p>
              <p>• KDV Tutarı: 800 TL</p>
              <p>• Toplam Tutar: 4.800 TL</p>
              <p><strong>ÖDEME BİLGİLERİ:</strong></p>
              <p>• Ödeme Yöntemi: Kredi kartı, banka kartı veya havale</p>
              <p>• Ödeme Vadesi: Peşin</p>
              <p><strong>TESLİMAT BİLGİLERİ:</strong></p>
              <p>• Teslimat Süresi: Anında (dijital içerik)</p>
              <p>• Teslimat Yöntemi: E-posta ile dijital erişim</p>
            </div>
            ...
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
              <input
                ...
                onChange={(e) => saveFormData({...formData, contract4_accepted: e.target.checked})}
                style={{ marginRight: '10px', transform: 'scale(1.2)' }}
              />
              <span style={{ fontSize: '14px', color: 'var(--text-dark)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p>Bu bilgilendirme, elektronik ticaret işlemleri kapsamında yapılmaktadır.</p>
              <p><strong>SATICI BİLGİLERİ:</strong></p>
              <p>• Firma Adı: HOOWELL GLOBAL ALKALİ İYONİZER SİSTEMLERİ ANONİM ŞİRKETİ</p>
              <p>• İletişim: info@hoowell.net</p>
              <p>• Web Sitesi: https://panel.hoowell.net</p>
              <p><strong>İŞLEM BİLGİLERİ:</strong></p>
              <p>• İşlem Türü: Elektronik ticaret satışı</p>
              <p>• Ürün: Dijital içerik ve franchise hakları</p>
              <p>• Ödeme: Elektronik ödeme sistemleri</p>
              <p><strong>GÜVENLİK:</strong></p>
              <p>• SSL sertifikası ile korumalı bağlantı</p>
            ...
            <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
              <input
                ...
                onChange={(e) => saveFormData({...formData, contract5_accepted: e.target.checked})}
                style={{ marginRight: '10px', transform: 'scale(1.2)' }}
              />
              <span style={{ fontSize: '14px', color: 'var(--text-dark)' }}>
                Elektronik ticaret bilgilendirmesini okudum, anladım ve kabul ediyorum.
              </span>
            </label>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <button
              ...
              style={{
                flex: 1,
                padding: '15px',
                backgroundColor: (!formData.contract1_accepted || !formData.contract2_accepted || !formData.contract3_accepted || !formData.contract4_accepted || !formData.contract5_accepted) ? '#ccc' : 'var(--primary-dark)',
                color: 'var(--white)',
                border: 'none',
                borderRadius: '10px',
                fontSize: '16px',
                fontWeight: 'bold',
                cursor: (!formData.contract1_accepted || !formData.contract2_accepted || !formData.contract3_accepted || !formData.contract4_accepted || !formData.contract5_accepted) ? 'not-allowed' : 'pointer'
              }}
            >
              Devam Et →
            </button>
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      setMessage('❌ PayTR hatası: ' + (error.response?.data?.message || 'Bilinmeyen hata'));
                    } finally {
                      setLoading(false);
                    }
                  }}
        ...
        {/* ADIM 7: Kayıt Tamamlama ve Kullanıcı Bilgileri */}
        {currentStep === 7 && (
          <div style={{
            backgroundColor: 'var(--card-gray)',
            borderRadius: '15px',
            ...
            {!loading && !message.includes('✅') ? (
              ...
              // Kayıt tamamlandı, giriş bilgilerini göster
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '80px', marginBottom: '20px' }}>🎉</div>
                <h2 style={{ color: 'var(--primary-dark)', marginBottom: '20px' }}>
                ...
                <p style={{ color: 'var(--text-light)', fontSize: '16px', marginBottom: '30px' }}>
                  İş ortağı kaydınız başarıyla oluşturuldu. Giriş bilgileriniz aşağıdadır.
                </p>
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'left', marginBottom: '20px' }}>
                    <p><strong>Kullanıcı Adı:</strong> {formData.email}</p>
                    <p><strong>Şifre:</strong> {formData.tc_no || formData.tax_no}</p>
                  ...
                  <div style={{
                    ...
                    <p style={{ color: '#1565c0', fontSize: '14px', margin: '0' }}>
                      💡 Giriş bilgilerinizi güvenli bir yerde saklayın. Şifrenizi değiştirmek için profil sayfanızı kullanabilirsiniz.
                    </p>
                  </div>
                </div>
